      ...
      {tab === "account" && (
        <SurfaceCard className="max-w-2xl space-y-4">
          ...
          <div className="space-y-1.5">
            <Label>E-posta</Label>
            <Input defaultValue="taylan@bodrumluxury.com" />
          </div>
          <div className="space-y-1.5">
            <Label>Telefon</Label>
            <Input defaultValue="+90 532 000 00 00" />
          </div>
          ...
          <Button
            onClick={() => toast.success("Hesap güncellendi")}
      ...
      {tab === "privacy" && (
        <SurfaceCard className="max-w-2xl space-y-2">
          ...
          <ToggleRow
            ...
            desc="Profiliniz tüm doğrulanmış üyelere açık"
            defaultChecked
          />
          <ToggleRow
            label="İletişim bilgilerini gizle"
            desc="Telefon ve e-posta yalnızca erişim onayında görünür"
            defaultChecked
          />
      ...
      {tab === "prefs" && (
        <SurfaceCard className="max-w-2xl space-y-4">
          ...
          <ToggleRow
            ...
            desc="Yeni detay talepleri için e-posta al"
            defaultChecked
          />
