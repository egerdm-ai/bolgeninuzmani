      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="mt-1.5 flex items-center gap-1.5 text-sm text-muted-foreground">
            ...
            {unlocked && portfolio.exactAddress && (
              <span className="text-secondary-foreground"> · {portfolio.exactAddress}</span>
            )}
          </p>
        </div>
        ...
        <InfoPanel title="Yaklaşık Konum">
          <ApproxLocationMap
            label={portfolio.regionLabel}
            radiusKm={portfolio.approxRadiusKm}
            x={50}
            y={48}
          />
        </InfoPanel>
        ...
        {mode === "owner" ? (
          <SurfaceCard className="border-success/25 bg-success/[0.04]">
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              Tüm bilgiler ve belgeler görünür durumda.
            </p>
          </SurfaceCard>
        ) : (
        ...
        {mode === "public" && (
          <SurfaceCard className="border-gold/30 bg-gold/[0.05] text-center">
            ...
            <p className="mt-2 text-sm font-semibold text-foreground">
              Bölgenin Uzmanı üyesi misiniz?
            </p>
            <p className="mt-1 text-xs text-muted-foreground">
              Tüm detaylara erişmek ve talep göndermek için giriş yapın.
            </p>
            <Button className="mt-3 w-full bg-gradient-gold text-primary-foreground hover:opacity-90">
              Giriş Yap / Başvur
            </Button>
          </SurfaceCard>
        )}
